...
const ActiveTask = () => {
  return (
    <div className='flex flex-col items-center rounded-2xl border border-activetask-border-dark dark:bg-activetask-bg-dark backdrop-blur-sm max-w-[min(480px,92vw)] mt-2 mb-5.5 mx-4 pt-3.5 pb-4 px-5.5 '>
